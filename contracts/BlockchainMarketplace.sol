...
//Confirm the user send vaild Data
    ...
    function buyProduct(uint _id) public payable{
        ...
        //Validation
        require( !singleProduct.sold,"This Product Sold");
        require( seller!= msg.sender,"Cannot Buy your Product");

        require(msg.value >= singleProduct.price,"The mount you send  should be equal product price ");
