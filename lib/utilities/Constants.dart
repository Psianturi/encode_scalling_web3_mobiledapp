...
class Constants {
  ...
  //Contract Data
  final CONTRACT_ADDRESS = "0x22abe64b9a31948e33e6189751812ce8fcb42e22";
  final CONTRACT_ABI_PATH = "assets/abi_file/MarketplaceProducts.json";

  //Blockchain Network Data
  final NETWORK_HTTPS_RPC = "https://sepolia.infura.io/v3/a3afa86728a2458089b75a54fb1717e8";
  final  NETWORK_WSS_RPC = "wss://sepolia.infura.io/ws/v3/a3afa86728a2458089b75a54fb1717e8";
  final CHAIN_ID =11155111;
  final imageMoke = "https://assets.nfprompt.io/image/jW6N3BGqyanQRJmBlqwdM45JVb9o72zw.png?x-oss-process=image/interlace,1/format,webp/resize,w_400,m_lfit";
  ...
  final mainRedColor =  Color(0xffC2161E);
    ...
    final List<String> categoryList = <String>[
      "Games","Art","Sport","Photograpghy", "3D","Collectables"
    ];
